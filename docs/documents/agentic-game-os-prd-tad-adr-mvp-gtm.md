...
continuity_id: "PLAN-AGENTIC-GAME-OS-PRD-TAD-ADR-MVP-GTM"
...
All five roles below consume `PLAN-AGENTIC-GAME-OS-PRD-TAD-ADR-MVP-GTM@1.1.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [Feature: Agentic Game OS](agentic-game-os-prd-tad-adr-mvp-gtm.md#feature-agentic-game-os) |
| TAD | [Architecture: Agentic Game OS](agentic-game-os-prd-tad-adr-mvp-gtm.md#architecture-agentic-game-os) |
| ADR | [ADR-1: Declared Registry Replaces the Shared Mode Union](agentic-game-os-prd-tad-adr-mvp-gtm.md#adr-1-declared-registry-replaces-the-shared-mode-union) |
| MVP | [MVP — reference implementation](agentic-game-os-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-game-os-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
