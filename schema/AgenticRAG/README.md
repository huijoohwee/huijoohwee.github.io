...
- Production release evidence belongs in `knowgrph/todo-log.md` as the canonical ledger row; for example the 2026-06-26 Dev->Prod->Cloudflare release is anchored by Dev `66926a74` + `e97df37c`, publish `0e4ab538`, preview `https://bdc25ab1.joohwee.pages.dev`, and live `https://airvio.co/knowgrph/`.
