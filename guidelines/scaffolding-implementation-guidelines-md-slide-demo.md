...
> **Diagram**: this guideline's phase diagram is owned by [Scaffold-to-Production Slide Deck Diagram](./scaffolding-implementation-slide-diagram.md). It is kept in its own document so the diagram payload does not load with every read of this guideline.
