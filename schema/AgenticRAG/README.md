...
- Sync stability: gate RxDB sync by `(graphDataRevision, collapsedGroupIdsKey)` so collapsed-view toggles update the table without introducing render/rewrite loops.
