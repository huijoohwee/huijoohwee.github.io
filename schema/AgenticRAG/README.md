...
- Knowgrph local collaboration keeps exactly one registered worktree per repository on each device and switches task branches in place; contributor tooling must fail closed on redundant linked worktrees rather than creating another checkout.
