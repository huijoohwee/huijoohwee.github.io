---
title: "Agentic SDLC Autonomous Continuation & Interaction Economy"
...
- A changed source, subject, scope, effect class, destructive reach, target, policy, or externally visible consequence invalidates the prior decision and requires a new one
