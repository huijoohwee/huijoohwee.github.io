...
- Production release evidence belongs in `knowgrph/todo-log.md` as the canonical ledger row; the current 2026-06-29 Dev->Prod->Cloudflare release is anchored by Dev `530462d6`, publish `ec4dfa47`, preview `https://0d3c18ba.joohwee.pages.dev`, live `https://airvio.co/` plus `https://airvio.co/knowgrph/`, and D1 docs seed `applied=41 conflict=0 rejected=0`.
