---
title: "Reference implementation: agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm section 1"
...
parent: "agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.md"
guideline_revision: "2.7.0"
source_section_lines: "1-367"
---

[Combined planning owner](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.md) · `PLAN-AGENTIC-OS-AI-PIPELINE-PRD-TAD-ADR-MVP-GTM@0.1.1`. This companion preserves the source section; diagrams and frontmatter projections remain owned by the combined artifact.
...
> **Machine source:** YAML frontmatter above the `---` delimiter — self-runnable, graph-complete, no external config required. · [↓ Flow Graph](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#flow-graph) · [↓ Pipeline](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#pipeline) · [↓ PRD](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#prd--product-requirements) · [↓ TAD](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#tad--technical-architecture)
...
[↑ Computing Flow Definition](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#computing-flow-definition)
...
All five roles below consume `PLAN-AGENTIC-OS-AI-PIPELINE-PRD-TAD-ADR-MVP-GTM@0.1.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [PRD — Product Requirements](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#prd--product-requirements) |
| TAD | [TAD — Technical Architecture](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#tad--technical-architecture) |
| ADR | [ADR: frontmatter authority - reference implementation](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#adr-frontmatter-authority---reference-implementation) |
| MVP | [MVP — reference implementation](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-os-ai-pipeline-prd-tad-adr-mvp-gtm.part-01.md#gtm--reference-implementation) |
...
## ADR: frontmatter authority - reference implementation

Retain the typed frontmatter as the executable specification and the body as its readable projection. The existing runner validates graph/step identity before computation; a separately maintained runtime configuration would duplicate those bindings. Keep the five projections consistent through their current validator and stop on mismatch. This template choice supplies no production execution, measured saving or paid-demand evidence; reopening it requires an explicit migration and round-trip proof.
